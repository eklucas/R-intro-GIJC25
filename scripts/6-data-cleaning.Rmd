...
The data used for these examples: disney.csv, osha.csv, poverty_original.csv
...
To start, let's deal with dates. 

There is a package called `lubridate` in tidyverse that will help you work with dates. You can use the lubridate cheatsheet (lubridate.pdf in the `tipsheets` folder) to search for the right function. 
